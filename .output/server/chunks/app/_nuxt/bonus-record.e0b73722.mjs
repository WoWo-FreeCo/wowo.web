...
import { b as useRouter, f as useCartStore, e as useAuthStore, u as useRuntimeConfig, G as GET_USER_BONUS_RECORDS } from '../server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(bonusRecords), (record) => {
        var _a2;
        _push(`<tr><td data-th="\u7570\u52D5\u65E5\u671F">${ssrInterpolate(getFormattedData(record == null ? void 0 : record.createdAt))}</td><td data-th="\u7570\u52D5\u8AAA\u660E">${ssrInterpolate(((_a2 = record == null ? void 0 : record.rules) == null ? void 0 : _a2.name) || "\u7D05\u5229\u9EDE\u6578")}</td><td data-th="\u9EDE\u6578">${ssrInterpolate(record == null ? void 0 : record.points)}</td></tr>`);
      });
      _push(`<!--]--></tbody></table>`);
      {
        _push(`<!---->`);
...
//# sourceMappingURL=bonus-record.e0b73722.mjs.map
