...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li class="${ssrRenderClass({ active: (_b = unref(path)) == null ? void 0 : _b.toLowerCase().includes("/profile") })}">`);
...
//# sourceMappingURL=ProfileSidebar.14114db9.mjs.map
