...
import { U as USER_LOGIN, a as GET_PROFILE } from './requestURL.290198d9.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'ufo';
      ...
      _push(ssrRenderComponent(_component_client_only, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="other_function"${_scopeId}> \u6C92\u6709\u5E33\u865F? <div${_scopeId}>`);
              ...
              createVNode("section", { class: "full_height mt185ptb30" }, [
                createVNode("div", { class: "container" }, [
                  ...
                  createVNode("div", { class: "contact-form" }, [
                    ...
                    createVNode("div", { class: "text-center mt-30" }, [
                      createVNode("i", { class: "fa-regular fa-circle-question" }),
                      createVNode(_component_NuxtLink, { to: "/forget" }, {
                        default: withCtx(() => [
                          createTextVNode(" \u5FD8\u8A18\u5BC6\u78BC? ")
                        ]),
                        _: 1
...
//# sourceMappingURL=login.8b77a7f9.mjs.map
