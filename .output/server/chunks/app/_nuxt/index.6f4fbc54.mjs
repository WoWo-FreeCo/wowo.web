...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "full_height mt185ptb30 pt0" }, _attrs))} data-v-a09cb076>`);
      _push(ssrRenderComponent(_component_UserProfile, null, null, _parent));
      _push(`<div class="row" data-v-a09cb076>`);
      _push(ssrRenderComponent(_component_ProfileSidebar, null, null, _parent));
      _push(`<div class="col-sm-9 pl20pr30" data-v-a09cb076><div class="contact-form" data-v-a09cb076><form id="" action="javascript:;" data-v-a09cb076><h4 class="mb-20" data-v-a09cb076> \u6703\u54E1\u57FA\u672C\u8CC7\u8A0A </h4><div class="form-group" data-v-a09cb076><label data-v-a09cb076>\u59D3\u540D*</label><input id="auth-realname"${ssrRenderAttr("value", unref(inputField).nickname)} type="text" placeholder="\u59D3\u540D*" class="form-control" name="" required data-v-a09cb076></div><div class="form-group" data-v-a09cb076><label data-v-a09cb076>\u624B\u6A5F*</label><input id="auth-mobile"${ssrRenderAttr("value", unref(inputField).cellphone)} type="text" placeholder="\u624B\u6A5F*" class="form-control" name="" required data-v-a09cb076></div><div class="form-group" data-v-a09cb076><label data-v-a09cb076>\u5E02\u8A71*</label><input id="auth-tele"${ssrRenderAttr("value", unref(inputField).telephone)} type="text" placeholder="\u5E02\u8A71*" class="form-control" name="" required data-v-a09cb076></div><div class="form-group" data-v-a09cb076><label data-v-a09cb076>\u9001\u8CA8\u5730\u5740*</label><input id="auth-address1"${ssrRenderAttr("value", unref(inputField).addressOne)} type="text" placeholder="\u9001\u8CA8\u5730\u5740*" class="form-control" name="" required data-v-a09cb076></div><div class="form-group" data-v-a09cb076><label data-v-a09cb076>\u9001\u8CA8\u5730\u57402</label><input id="auth-address2"${ssrRenderAttr("value", unref(inputField).addressTwo)} type="text" placeholder="\u9001\u8CA8\u5730\u57402" class="form-control" name="" data-v-a09cb076></div><div class="form-group" data-v-a09cb076><label data-v-a09cb076>\u9001\u8CA8\u5730\u57403</label><input id="auth-address3"${ssrRenderAttr("value", unref(inputField).addressThree)} type="text" placeholder="\u9001\u8CA8\u5730\u57403" class="form-control" name="" data-v-a09cb076></div><div class="text-center" data-v-a09cb076><button type="reset" class="btn btn-main btn-default" data-v-a09cb076> \u53D6\u6D88\u91CD\u586B </button><input id="edit-confirm" type="submit" class="btn btn-main btn-bag" value="\u78BA\u8A8D\u9001\u51FA" data-v-a09cb076></div></form></div></div></div><div id="member_vip_root" class="bg_left2" data-v-a09cb076><div id="member_vip" class="level_frame" data-v-a09cb076><h3 class="level_tl" data-v-a09cb076><span data-v-a09cb076>\u76EE\u524D\u7D1A\u5225\uFF1A</span>${ssrInterpolate(unref(currentLevel))} <a href="#" data-toggle="modal" data-target="#vipdesc" data-v-a09cb076><i class="fa-solid fa-circle-question" data-v-a09cb076></i> <u data-v-a09cb076>\u67E5\u770B\u5347\u7B49\u65B9\u5F0F</u></a></h3><div class="row level_content" data-v-a09cb076>`);
      if (unref(authUser).memberLevel === "NORMAL") {
        _push(`<div data-v-a09cb076><h4 data-v-a09cb076>\u6211\u8981\u89E3\u9396\u6210\u70BA<span data-v-a09cb076>VIP</span>\uFF1A<span class="level_tips" data-v-a09cb076>\u300EA.\u7D81\u5B9AVIP\u63A8\u85A6\u4EBA\u300F+\u300EB.\u6309\u8B9AWO\u7C89\u7D72\u5718\u6216C.\u8A02\u95B1WO\u983B\u9053\u300F\uFF0C\u5373\u53EF\u6210\u70BAVIP!</span></h4></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(authUser).memberLevel === "VIP") {
        _push(`<div data-v-a09cb076><h4 data-v-a09cb076>\u6211\u8981\u89E3\u9396\u6210\u70BA<span data-v-a09cb076>SVIP</span>\uFF1A<span class="level_tips" data-v-a09cb076>\u300ED.\u7D81\u5B9ASVIP\u6FC0\u6D3B\u78BC\u300F\u6216\u300EB.\u6309\u8B9AWO\u7C89\u7D72\u5718+C.\u8A02\u95B1WO\u983B\u9053\u300F\uFF0C\u5373\u53EF\u6210\u70BASVIP!</span></h4></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(authUser).memberLevel === "NORMAL") {
        _push(`<div class="col-sm-6 border-right" data-v-a09cb076><h5 data-v-a09cb076>A.VIP\u63A8\u85A6\u4EBA<span class="level_tips" data-v-a09cb076>(\u7D81\u5B9A\u63A8\u85A6\u4EBA\u5E33\u865F\u5F8C\u5C07\u7121\u6CD5\u89E3\u9396\uFF01)</span></h5><form id="vip_rec" action="javascript:;" class="form-group" data-v-a09cb076><input style="${ssrRenderStyle(!unref(authUser).VIPActivated ? null : { display: "none" })}"${ssrRenderAttr("value", unref(inputVIPCode))} type="text" placeholder="\u8ACB\u8F38\u5165VIP\u63A8\u85A6\u5E33\u865F (\u6703\u54E1\u5E33\u865F)" class="form-control" data-v-a09cb076><button type="button" class="${ssrRenderClass([{ "btn-check": !unref(authUser).VIPActivated, "btn-default": unref(authUser).VIPActivated }, "btn btn-block"])}"${ssrIncludeBooleanAttr(unref(authUser).VIPActivated) ? " disabled" : ""} data-v-a09cb076><i style="${ssrRenderStyle(unref(authUser).VIPActivated ? null : { display: "none" })}" class="fa-solid fa-circle-check" data-v-a09cb076></i> ${ssrInterpolate(!unref(authUser).VIPActivated ? "\u524D\u5F80\u7D81\u5B9A" : "\u5DF2\u7D81\u5B9A")}</button></form></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="${ssrRenderClass([{
        "display-none": unref(authUser).memberLevel === "NORMAL"
      }, "col-sm-6 border-right svip-code"])}" data-v-a09cb076><h5 data-v-a09cb076>A.SVIP\u6FC0\u6D3B\u78BC<span class="level_tips" data-v-a09cb076>(\u7D81\u5B9A\u63A8\u85A6\u4EBA\u5E33\u865F\u5F8C\u5C07\u7121\u6CD5\u89E3\u9396\uFF01)</span></h5><form id="svip_rec" action="javascript:;" class="form-group" data-v-a09cb076><input style="${ssrRenderStyle(!unref(authUser).SVIPActivated ? null : { display: "none" })}"${ssrRenderAttr("value", unref(inputSVIPCode))} type="text" placeholder="\u8ACB\u8F38\u5165SVIP\u6FC0\u6D3B\u78BC" class="form-control"${ssrIncludeBooleanAttr(unref(authUser).memberLevel === "SVIP") ? " disabled" : ""} data-v-a09cb076><button type="button" class="${ssrRenderClass([{
        "btn-check": !unref(authUser).SVIPActivated,
        "btn-default": unref(authUser).SVIPActivated
      }, "btn btn-block"])}"${ssrIncludeBooleanAttr(unref(authUser).SVIPActivated || unref(authUser).memberLevel === "SVIP") ? " disabled" : ""} data-v-a09cb076><i style="${ssrRenderStyle(unref(authUser).SVIPActivated ? null : { display: "none" })}" class="fa-solid fa-circle-check" data-v-a09cb076></i> ${ssrInterpolate(!unref(authUser).SVIPActivated ? "\u524D\u5F80\u7D81\u5B9A" : "\u5DF2\u7D81\u5B9A")}</button></form></div><div class="col-sm-6" data-v-a09cb076><form data-v-a09cb076><h5 data-v-a09cb076>B.FB\u7C89\u7D72\u7D81\u5B9A<span class="level_tips" data-v-a09cb076>(\u6309\u8B9AWO\u7C89\u7D72\u5718)</span></h5>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="${ssrRenderClass([{ "btn-check": !unref(clickedFB), "btn-default": unref(clickedFB) }, "btn btn-block"])}"${ssrIncludeBooleanAttr(unref(clickedFB)) ? " disabled" : ""} data-v-a09cb076${_scopeId}><i style="${ssrRenderStyle(unref(clickedFB) ? null : { display: "none" })}" class="fa-solid fa-circle-check" data-v-a09cb076${_scopeId}></i> ${ssrInterpolate(!unref(clickedFB) ? "\u524D\u5F80\u7D81\u5B9A" : "\u5DF2\u7D81\u5B9A")}</button>`);
          } else {
            return [
              createVNode("button", {
                type: "button",
      ...
      _push(`</form><form class="mt-10" data-v-a09cb076><h5 data-v-a09cb076>C.Youtube\u983B\u9053\u7D81\u5B9A<span class="level_tips" data-v-a09cb076>(\u8A02\u95B1WO\u983B\u9053)</span></h5>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        target: "_blank",
        to: unref(youtubeURL),
      ...
      _push(`</form><form class="mt-10" data-v-a09cb076><h5 data-v-a09cb076>D.IG\u8FFD\u8E64\u7D81\u5B9A<span class="level_tips" data-v-a09cb076>(\u8A02\u95B1WO IG)</span></h5>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        target: "_blank",
        to: unref(igURL),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a09cb076"]]);

export { index as default };
//# sourceMappingURL=index.6f4fbc54.mjs.map
