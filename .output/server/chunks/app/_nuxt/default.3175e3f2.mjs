...
import { u as usePageStatusStore } from './pageStatusStore.be2d5fb7.mjs';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "top_nav" }, _attrs))} data-v-19958b4c><div class="container2 relative p-0" data-v-19958b4c><div id="logo" class="logo" data-v-19958b4c>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-19958b4c${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0$1,
      ...
      _push(`</div><section class="top-header" data-v-19958b4c><ul id="top_member" class="top-menu" data-v-19958b4c><li data-v-19958b4c>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/favorite" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fa-regular fa-heart" data-v-19958b4c${_scopeId}></i>`);
          } else {
            return [
      ...
      _push(`</li><li class="top_cart" data-v-19958b4c>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/cart" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b, _c, _d;
          if (_push2) {
            _push2(`<i class="fa-solid fa-cart-shopping" data-v-19958b4c${_scopeId}></i><span style="${ssrRenderStyle(((_a = unref(cartStore)) == null ? void 0 : _a.merch.length) > 0 ? null : { display: "none" })}" class="badge badge-pink" data-v-19958b4c${_scopeId}>${ssrInterpolate((_b = unref(cartStore)) == null ? void 0 : _b.merch.length)}</span>`);
          } else {
            return [
      ...
      _push(`</li><li style="${ssrRenderStyle(unref(isLoggedIn) && false ? null : { display: "none" })}" class="top_bell" data-v-19958b4c><a href="javascript:;" data-v-19958b4c><i class="fa-regular fa-bell" data-v-19958b4c></i>`);
      if (unref(messagesAmount)) {
        _push(`<span class="badge badge-green bell_bounce" data-v-19958b4c>${ssrInterpolate(unref(messagesAmount))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</a></li>`);
      if (!unref(isLoggedIn)) {
        _push(`<li data-v-19958b4c>`);
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/login" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fa-regular fa-user" data-v-19958b4c${_scopeId}></i>`);
            } else {
              return [
        ...
        _push(`<li class="dropdown dropdown-slide" data-v-19958b4c><a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-v-19958b4c><i class="fa-regular fa-user" data-v-19958b4c></i></a><ul class="dropdown-menu" data-v-19958b4c><li data-v-19958b4c>`);
        ...
        _push(`</li><li data-v-19958b4c><a href="javascript:;" data-v-19958b4c>\u767B\u51FA</a></li></ul></li>`);
      }
      _push(`</ul></section><div id="menuToggle" data-v-19958b4c><input${ssrIncludeBooleanAttr(Array.isArray(unref(menuToggle)) ? ssrLooseContain(unref(menuToggle), null) : unref(menuToggle)) ? " checked" : ""} type="checkbox" data-v-19958b4c><span data-v-19958b4c></span><span data-v-19958b4c></span><span data-v-19958b4c></span><ul id="menu" data-v-19958b4c><li data-v-19958b4c>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-19958b4c"]]);
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-97f07822><div class="modal-dialog" role="document" data-v-97f07822><div class="modal-content" data-v-97f07822><div class="modal-body" data-v-97f07822><div class="embed-responsive embed-responsive-16by9" data-v-97f07822><iframe width="560" height="315" src="https://www.youtube.com/embed/oy8m9i9Mtx4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;" allowfullscreen data-v-97f07822></iframe></div></div>`);
      if (unref(countdown) <= 0) {
        _push(`<div class="modal-footer btn-close" data-v-97f07822><button type="button" class="btn btn-default" data-v-97f07822> \u95DC\u9589 </button></div>`);
      } else {
        _push(`<div class="hint" data-v-97f07822> \u8ACB\u7B49\u5F85 ${ssrInterpolate(unref(countdown))} \u79D2... </div>`);
      }
      _push(`</div></div></div>`);
    };
  }
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-97f07822"]]);
...
`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-bea69d73><div class="modal-dialog" role="document" data-v-bea69d73><div class="modal-content" data-v-bea69d73><div class="modal-title" data-v-bea69d73><h4 data-v-bea69d73>\u6211\u7684\u597D\u53CB,\u9001\u4F60\u4E00\u5247\u597D\u5EB7</h4></div><div class="modal-body" data-v-bea69d73><img class="main-img"${ssrRenderAttr("src", _imports_0)} alt="" data-v-bea69d73> \u597D\u6771\u897F,\u7576\u7136\u8981\u518D\u5206\u4EAB\u7D66\u53E3\u888B\u540D\u55AE!<br data-v-bea69d73> \u5206\u4EAB\u9019\u5247\u512A\u60E0\u7D66\u597D\u53CB,\u4E5F\u8B93\u597D\u53CB\u4E00\u8D77\u62FF\u5230\u8D85\u4F4E\u512A\u60E0\u50F9<br data-v-bea69d73><br data-v-bea69d73> \u65B9\u5F0F\uFF1A\u9EDE\u9078\u4E0B\u65B9\u6309\u9215\u514D\u8CBB\u52A0\u5165\u6703\u54E1, \u5B8C\u6210\u6D41\u7A0B\u5F8C, \u5C31\u80FD\u4EAB\u53D7VIP \u548CSVIP\u7684\u8D85\u4F4E\u7279\u60E0\u50F9 <div class="text-center" data-v-bea69d73> \u5206\u4EAB<br data-v-bea69d73><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.facebook.com%2FLOVIN2022" target="_blank" data-v-bea69d73><i class="fa-brands fa-facebook" style="${ssrRenderStyle({ "font-size": "28px" })}" data-v-bea69d73></i></a><a href="https://www.instagram.com/p/Co1EeQHpvmD/?igshid=MDJmNzVkMjY=" target="_blank" data-v-bea69d73><i class="fa-brands fa-instagram" style="${ssrRenderStyle({ "font-size": "28px" })}" data-v-bea69d73></i></a><a href="https://youtu.be/9RlTDp0BBUw" target="_blank" data-v-bea69d73><i class="fa-brands fa-youtube" style="${ssrRenderStyle({ "font-size": "28px" })}" data-v-bea69d73></i></a><br data-v-bea69d73><a id="copy-btn" class="btn btn-main btn-check"${ssrRenderAttr("data-clipboard-text", unref(shareURL))} data-v-bea69d73>\u8907\u88FD\u5206\u4EAB\u7DB2\u5740</a></div></div><div class="modal-footer" data-v-bea69d73><button type="button" class="btn btn-check2" data-v-bea69d73> \u95DC\u9589 </button></div></div></div></div>`);
    };
  }
};
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-bea69d73"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=default.3175e3f2.mjs.map
