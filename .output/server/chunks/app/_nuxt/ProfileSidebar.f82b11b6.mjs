import { a as useAuthStore, b as useRouter, g as useRoute, f as __nuxt_component_0$1 } from '../server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li class="${ssrRenderClass({ active: (_b = unref(path)) == null ? void 0 : _b.toLowerCase().includes("/bonus-record") })}">`);
      ...
      _push(`</li><li class="${ssrRenderClass({ active: (_c = unref(path)) == null ? void 0 : _c.toLowerCase().includes("/favorite") })}">`);
      ...
      _push(`</li><li class="${ssrRenderClass({ active: (_d = unref(path)) == null ? void 0 : _d.toLowerCase().includes("/order") })}">`);
...
//# sourceMappingURL=ProfileSidebar.f82b11b6.mjs.map
