import { _ as _export_sfc, a as useRouter, f as __nuxt_component_0$1 } from '../server.mjs';
import { u as useAuthStore } from './authStore.dc07c484.mjs';
import { u as useCartStore } from './cartStore.140f037b.mjs';
import { u as usePageStatusStore } from './pageStatusStore.4e351736.mjs';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "top_nav" }, _attrs))} data-v-db8b50a7><div class="container2 relative p-0" data-v-db8b50a7><div id="logo" class="logo" data-v-db8b50a7>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-db8b50a7${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0$1,
      ...
      _push(`</div><section class="top-header" data-v-db8b50a7><ul id="top_member" class="top-menu" data-v-db8b50a7><li data-v-db8b50a7>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/favorite" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fa-regular fa-heart" data-v-db8b50a7${_scopeId}></i>`);
          } else {
            return [
      ...
      _push(`</li><li class="top_cart" data-v-db8b50a7>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/cart" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b, _c, _d;
          if (_push2) {
            _push2(`<i class="fa-solid fa-cart-shopping" data-v-db8b50a7${_scopeId}></i><span style="${ssrRenderStyle(((_a = unref(cartStore)) == null ? void 0 : _a.merch.length) > 0 ? null : { display: "none" })}" class="badge badge-pink" data-v-db8b50a7${_scopeId}>${ssrInterpolate((_b = unref(cartStore)) == null ? void 0 : _b.merch.length)}</span>`);
          } else {
            return [
      ...
      _push(`</li><li style="${ssrRenderStyle(unref(isLoggedIn) ? null : { display: "none" })}" class="top_bell" data-v-db8b50a7><a href="javascript:;" data-v-db8b50a7><i class="fa-regular fa-bell" data-v-db8b50a7></i>`);
      if (unref(messagesAmount)) {
        _push(`<span class="badge badge-green bell_bounce" data-v-db8b50a7>${ssrInterpolate(unref(messagesAmount))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</a></li>`);
      if (!unref(isLoggedIn)) {
        _push(`<li data-v-db8b50a7>`);
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/login" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fa-regular fa-user" data-v-db8b50a7${_scopeId}></i>`);
            } else {
              return [
        ...
        _push(`<li class="dropdown dropdown-slide" data-v-db8b50a7><a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-v-db8b50a7><i class="fa-regular fa-user" data-v-db8b50a7></i></a><ul class="dropdown-menu" data-v-db8b50a7><li data-v-db8b50a7>`);
        ...
        _push(`</li><li data-v-db8b50a7><a href="javascript:;" data-v-db8b50a7>\u767B\u51FA</a></li></ul></li>`);
      }
      _push(`</ul></section><div id="menuToggle" data-v-db8b50a7><input${ssrIncludeBooleanAttr(Array.isArray(unref(menuToggle)) ? ssrLooseContain(unref(menuToggle), null) : unref(menuToggle)) ? " checked" : ""} type="checkbox" data-v-db8b50a7><span data-v-db8b50a7></span><span data-v-db8b50a7></span><span data-v-db8b50a7></span><ul id="menu" data-v-db8b50a7><li data-v-db8b50a7>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-db8b50a7"]]);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-ace0fe3a"]]);
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-a23280db><div class="modal-dialog" role="document" data-v-a23280db><div class="modal-content" data-v-a23280db><div class="modal-body" data-v-a23280db><div class="embed-responsive embed-responsive-16by9" data-v-a23280db><iframe width="560" height="315" src="https://www.youtube.com/embed/oy8m9i9Mtx4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;" allowfullscreen data-v-a23280db></iframe></div></div>`);
      if (unref(countdown) <= 0) {
        _push(`<div class="modal-footer btn-close" data-v-a23280db><button type="button" class="btn btn-default" data-v-a23280db> \u95DC\u9589 </button></div>`);
      } else {
        _push(`<div class="hint" data-v-a23280db> \u8ACB\u7B49\u5F85 ${ssrInterpolate(unref(countdown))} \u79D2... </div>`);
      }
      _push(`</div></div></div>`);
    };
  }
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a23280db"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-2738be69><div class="modal-dialog" role="document" data-v-2738be69><div class="modal-content" data-v-2738be69><div class="modal-title" data-v-2738be69><h4 data-v-2738be69>\u6211\u7684\u597D\u53CB,\u9001\u4F60\u4E00\u5247\u597D\u5EB7</h4></div><div class="modal-body" data-v-2738be69><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-2738be69> \u597D\u6771\u897F,\u7576\u7136\u8981\u518D\u5206\u4EAB\u7D66\u53E3\u888B\u540D\u55AE!<br data-v-2738be69> \u5206\u4EAB\u9019\u5247\u512A\u60E0\u7D66\u597D\u53CB,\u4E5F\u8B93\u597D\u53CB\u4E00\u8D77\u62FF\u5230\u8D85\u4F4E\u512A\u60E0\u50F9<br data-v-2738be69><br data-v-2738be69> \u65B9\u5F0F\uFF1A\u9EDE\u9078\u4E0B\u65B9\u6309\u9215\u514D\u8CBB\u52A0\u5165\u6703\u54E1, \u5B8C\u6210\u6D41\u7A0B\u5F8C, \u5C31\u80FD\u4EAB\u53D7VIP \u548CSVIP\u7684\u8D85\u4F4E\u7279\u60E0\u50F9 <div class="text-center" data-v-2738be69> \u5206\u4EAB<br data-v-2738be69><a href="" data-v-2738be69><i class="fa-brands fa-facebook" style="${ssrRenderStyle({ "font-size": "28px" })}" data-v-2738be69></i></a> <a href="" data-v-2738be69><i class="fa-brands fa-line" style="${ssrRenderStyle({ "font-size": "28px" })}" data-v-2738be69></i></a><br data-v-2738be69><a class="btn btn-main btn-check" data-v-2738be69>\u8907\u88FD\u5206\u4EAB\u7DB2\u5740</a></div></div><div class="modal-footer" data-v-2738be69><button type="button" class="btn btn-check2" data-v-2738be69> \u95DC\u9589 </button></div></div></div></div>`);
    };
  }
};
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-2738be69"]]);
const _sfc_main$1 = {};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout--default" }, _attrs))} data-v-bd145085>`);
      ...
      _push(ssrRenderComponent(_component_VideoDialogue, {
        style: unref(pageStatus).videoDialogToggle ? null : { display: "none" }
      }, null, _parent));
      _push(ssrRenderComponent(_component_ShareAccount, {
        style: unref(pageStatus).shareAccountToggle ? null : { display: "none" }
      }, null, _parent));
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bd145085"]]);

export { _default as default };
//# sourceMappingURL=default.0399242d.mjs.map
