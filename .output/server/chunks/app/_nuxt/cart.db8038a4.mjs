...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    watch(routes, (_new) => {
      updateCartType();
      console.log(cartStore == null ? void 0 : cartStore.merch.filter((e) => e.attribute === "COLD_CHAIN"));
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div style="${ssrRenderStyle(unref(currentMerch).length ? null : { display: "none" })}" class="alert alert-warning alert-common" role="alert"> \u904B\u9001\u63D0\u9192\uFF0Cex\uFF1A\u5B85\u914D\u586B\u5BEB\u5230\u8CA8\u6642\u9593 </div><div style="${ssrRenderStyle(unref(currentMerch).length ? null : { display: "none" })}" class="alert alert-warning alert-common" role="alert"> \u8CBC\u5FC3\u63D0\u9192: \u4E00\u822C\u5E38\u6EAB\u5546\u54C1,\u7121\u6CD5\u8207\u51B7\u934A\u5546\u54C1\u540C\u6642\u51FA\u8CA8, \u656C\u8ACB\u5206\u958B\u7D50\u5E33,\u8B1D\u8B1D\u60A8 </div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=cart.db8038a4.mjs.map
