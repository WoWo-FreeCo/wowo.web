  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(authUser).memberLevel !== "SVIP") {
        ...
        _push(`<a href="#" data-toggle="modal" data-target="#vipdesc" class="lvdesc_a">\u7B49\u7D1A\u8AAA\u660E</a></li>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=UserProfile.20177f26.mjs.map
