...
import { u as usePageStatusStore } from './pageStatusStore.49fe501e.mjs';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "top_nav" }, _attrs))} data-v-3255b1f5><div class="container2 relative p-0" data-v-3255b1f5><div id="logo" class="logo" data-v-3255b1f5>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-3255b1f5${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0$1,
      ...
      _push(`</div><section class="top-header" data-v-3255b1f5><ul id="top_member" class="top-menu" data-v-3255b1f5><li data-v-3255b1f5>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/favorite" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b, _c, _d;
          if (_push2) {
            _push2(`<i class="fa-regular fa-heart" data-v-3255b1f5${_scopeId}></i><span style="${ssrRenderStyle(((_a = unref(cartStore)) == null ? void 0 : _a.favMerch.length) > 0 ? null : { display: "none" })}" class="badge badge-pink" data-v-3255b1f5${_scopeId}>${ssrInterpolate((_b = unref(cartStore)) == null ? void 0 : _b.favMerch.length)}</span>`);
          } else {
            return [
      ...
      _push(`</li><li class="top_cart" data-v-3255b1f5>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/cart" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b, _c, _d;
          if (_push2) {
            _push2(`<i class="fa-solid fa-cart-shopping" data-v-3255b1f5${_scopeId}></i><span style="${ssrRenderStyle(((_a = unref(cartStore)) == null ? void 0 : _a.merch.length) > 0 ? null : { display: "none" })}" class="badge badge-pink" data-v-3255b1f5${_scopeId}>${ssrInterpolate((_b = unref(cartStore)) == null ? void 0 : _b.merch.length)}</span>`);
          } else {
            return [
      ...
      _push(`</li><li style="${ssrRenderStyle(unref(isLoggedIn) && false ? null : { display: "none" })}" class="top_bell" data-v-3255b1f5><a href="javascript:;" data-v-3255b1f5><i class="fa-regular fa-bell" data-v-3255b1f5></i>`);
      if (unref(messagesAmount)) {
        _push(`<span class="badge badge-green bell_bounce" data-v-3255b1f5>${ssrInterpolate(unref(messagesAmount))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</a></li>`);
      if (!unref(isLoggedIn)) {
        _push(`<li data-v-3255b1f5>`);
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/login" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fa-regular fa-user" data-v-3255b1f5${_scopeId}></i>`);
            } else {
              return [
        ...
        _push(`<li class="dropdown dropdown-slide" data-v-3255b1f5><a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-v-3255b1f5><i class="fa-regular fa-user" data-v-3255b1f5></i></a><ul class="dropdown-menu" data-v-3255b1f5><li data-v-3255b1f5>`);
        ...
        _push(`</li><li data-v-3255b1f5><a href="javascript:;" data-v-3255b1f5>\u767B\u51FA</a></li></ul></li>`);
      }
      _push(`</ul></section><div id="menuToggle" data-v-3255b1f5><input${ssrIncludeBooleanAttr(Array.isArray(unref(menuToggle)) ? ssrLooseContain(unref(menuToggle), null) : unref(menuToggle)) ? " checked" : ""} type="checkbox" data-v-3255b1f5><span data-v-3255b1f5></span><span data-v-3255b1f5></span><span data-v-3255b1f5></span><ul id="menu" data-v-3255b1f5><li data-v-3255b1f5>`);
      ...
      _push(`</li><li style="${ssrRenderStyle({ display: "none" })}" data-v-3255b1f5>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-3255b1f5"]]);
...
//# sourceMappingURL=default.fe33482b.mjs.map
